...
class quranTap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color currentColor = Color(0xffB7935F);
      ...
      children: [
        ...
        Image.asset(
          provider.mode == ThemeMode.light
              ...
              : 'assets/images/quran_head_dark.png',
          height: 170,
        ),
        Container(
          ...
          child: Table(
            border: TableBorder(
                top: BorderSide(color: currentColor, width: 3),
                bottom: BorderSide(color: currentColor, width: 3),
                verticalInside: BorderSide(color: currentColor, width: 3)),
            children: [
              TableRow(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("suraNameTitle".tr(),
